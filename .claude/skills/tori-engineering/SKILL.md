...
6. **Entregar**: copiar a `/mnt/user-data/outputs/`, presentar el archivo, y dar un resumen en español: directo, breve, qué se cambió, qué se probó y qué dio cada prueba. Recordarle a Andrés reemplazar la versión en el conocimiento del proyecto.
